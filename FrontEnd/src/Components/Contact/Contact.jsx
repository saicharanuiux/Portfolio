    ...
    <div className="contact-container">
      ...
      <form onSubmit={handleSubmit} className="contact-form">
        <div className="form-group">
          <label htmlFor="name" style={formData.name ? {color : "var(--color-text)"} : {}}>Your Name</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div className="form-group">
          <label htmlFor="email" style={formData.email ? {color : "var(--color-text)"} : {}}>Your Email</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div className="form-group">
          <label htmlFor="message" style={formData.message ? {color : "var(--color-text)"} : {}}>Message</label>
          <textarea
            id="message"
            name="message"
            rows="5"
